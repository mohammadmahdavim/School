...
@section('script')
    ...
    <script src="/assets/vendors/dataTable/dataTables.bootstrap4.min.jsf_name"></script>
                            ...
                            @elseif($mail->status == 1)
                                <tr style="color: #0000cc">
                                    ...
                                    <td class="table-inbox-name">
                                        <a href="<?= url('/mail/showin/' . $mail->mail_id); ?>">
                                            @if(getAuthor(getMyMail($mail->mail_id)->user_id))
                                            <div class="letter-icon-title text-default">{{ getAuthor(getMyMail($mail->mail_id)->user_id)->f_name.' '.getAuthor(getMyMail($mail->mail_id)->user_id)->l_name  }}
                                            @endif
                                            </div>
                                        </a>
                                    </td>
